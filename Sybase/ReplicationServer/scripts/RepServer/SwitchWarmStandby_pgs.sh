...
go
exec sp_kill_process ${DBName}, smsmaint       
go
exec sp_kill_process ${DBName}, cmuser
go
exec sp_kill_process ${DBName}, pgsuser
go
exec sp_kill_process ${DBName}, ccdmaint
go
exec sp_kill_process ${DBName}, web
go
