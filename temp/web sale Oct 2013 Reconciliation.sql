...
where t.xactionId in ( select xactionId from report_db..usd ) 
  and t.taxCountryId != 244
...
--from  report_db..WebSaleTran2013Oct t
from Accounting..Purchase t
where t.xactionId in ( select xactionId from report_db..usd )   --9583.80
...
select * from Accounting..CreditCardTransaction where xactionId in (
123580524,
123580849,
123580858
)
select * from Accounting..CreditCardTransaction where xactionId >= 123580800 and xactionId <= 123580858

select * from Accounting..OptimalPaymentsResponse res where res.activityId  in (
123580524,
123580849,
123580858
)
...
select * from report_db..usd where xactionId in (
123580524,
123580849,
123580858
)
